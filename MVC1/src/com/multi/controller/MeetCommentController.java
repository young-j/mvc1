 ...
 */
@WebServlet("/meetcomment.do")
public class MeetCommentController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{ 
			...
			url =request.getContextPath() + "/meetcomment.do?cmd=list";
		}
	...
	void doList(HttpServletRequest request, HttpServletResponse response) 
		...
		MeetCommentDao dao = new MeetCommentDao();
		MeetCommentDto dto = new MeetCommentDto();
		
		String board_id=request.getParameter("board_id");
		dto.setBoard_id(board_id);
		
		List<MeetCommentDto> list = dao.getList(dto);
		...
		for(int i=0; i<list.size(); i++)
		{
			...
			MeetCommentDto tempDto = list.get(i);
