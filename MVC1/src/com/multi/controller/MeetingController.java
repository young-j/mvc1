...
import com.multi.model.MeetingDao;
...
public class MeetingController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(cmd.equals("view"))
		{
			...
			url="/meeting/view.jsp";
		}
		else if(cmd.equals("write"))
		{ 
			url="/meeting/write.jsp";
		}
		...
		else if(cmd.equals("save"))
		{
			...
			url =request.getContextPath() + "/meeting.do?cmd=list&category="+category;
		}
		else if(cmd.equals("delete"))
		{
			...
			url =request.getContextPath() + "/meeting.do?cmd=list";
		}
	...
	throws ServletException, IOException {
		...
		String savePath =	ctx.getRealPath(Util.FILE_UPLOAD_BASE+"/meeting");
