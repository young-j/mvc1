...
import com.multi.model.GallCommentDao;
 ...
 */
@WebServlet("/gallcomment.do")
public class GallCommentController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{ 
			...
			url =request.getContextPath() + "/gallcomment.do?cmd=list";
		}
	...
	void doList(HttpServletRequest request, HttpServletResponse response) 
		...
		GallCommentDto dto = new GallCommentDto();
		
		String board_id=request.getParameter("board_id");
		dto.setBoard_id(board_id);
		
		List<GallCommentDto> list = dao.getList(dto);
		...
		for(int i=0; i<list.size(); i++)
		{
			...
			GallCommentDto tempDto = list.get(i);
