...
public class GuestbookController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(cmd.equals("view"))
		{
			...
			url="/guestbook/view.jsp";
		}
		else if(cmd.equals("write"))
		{ 
			url="/guestbook/write.jsp";
		}
		else if(cmd.equals("gallery"))
		{ 
			url="/guestbook/gallery.jsp";
		}
		...
		else if(cmd.equals("save"))
		{
			...
			url =request.getContextPath() + "/guest.do?cmd=list";
		}
	...
	throws ServletException, IOException {
		...
		String savePath =	ctx.getRealPath(Util.FILE_UPLOAD_BASE+"/guestbook");
