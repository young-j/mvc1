...
import com.multi.model.NoticeCommentDao;
...
public class NoticeCommentController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{ 
			...
			url =request.getContextPath() + "/noticecomment.do?cmd=list";
		}
	...
	void doList(HttpServletRequest request, HttpServletResponse response) 
		...
		List<NoticeCommentDto> list = dao.getList(dto);
		...
		for(int i=0; i<list.size(); i++)
		{
			...
			NoticeCommentDto tempDto = list.get(i);
