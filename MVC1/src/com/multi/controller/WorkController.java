...
import com.multi.model.WorkDao;
...
public class WorkController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(cmd.equals("save"))
		{
			...
			url =request.getContextPath() + "/work.do?cmd=list&category="+category;
		}
		else if(cmd.equals("delete"))
		{
			...
			url =request.getContextPath() + "/work.do?cmd=list";
		}
	...
	throws ServletException, IOException {
		...
		String savePath =	ctx.getRealPath(Util.FILE_UPLOAD_BASE+"/work");
