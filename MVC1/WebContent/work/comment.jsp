  ...
  <form action="" name="myform" method="get">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td colspan="5">
        	<a href="<%=contextPath%>/download.do?path=work&filename=<%=dto.getFileName1()%>"><%=dto.getFileName1()%></a>
        </td>
      </tr>
       <tr>
        <th class="table-secondary">첨부2</th>
          <td colspan="5">
        	<a href="<%=contextPath%>/download.do?path=work&filename=<%=dto.getFileName2()%>"><%=dto.getFileName2()%></a>
        </td>
      </tr>
       <tr>
        <th class="table-secondary">첨부3</th>
        <td colspan="5">
        	<a href="<%=contextPath%>/download.do?path=work&filename=<%=dto.getFileName3()%>"><%=dto.getFileName3()%></a>
        </td>
      </tr>
