...
String category_name=Util.getMeetingCategoryName(category);
...
function goWrite()
{
	...
	frm.contents=data;
	frm.action="/MVC1/meeting.do?cmd=save";
...
function goReply()
{
	...
	frm.action="<%=contextPath%>/meeting.do";
	frm.submit();
}
...
function loadData() {
	var board_id = $("#id").val();
	$.ajax({
		url: "<%=request.getContextPath()%>/meetcomment.do", // 호출할 파일명
