...
GalleryDto comDto = (GalleryDto)request.getAttribute("comDto");
%>
  	...
  	<tbody></tbody>
			...
			<section style="margin-top:40px">
			  <form name="frmComment" >
			  		...
			  		<input type="text" name="username" id="username" value="<%=username%>" readonly >					<div class="form-group">
...
function loadData() {
	var board_id = $("#id").val();
	$.ajax({
		url: "<%=request.getContextPath()%>/noticecomment.do", // 호출할 파일명
