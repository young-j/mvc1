var styleSwitcher = {
    ...
    initialize: function() {
        ...
        if (!this.initialized) {
            if ($("html").hasClass("ie8")) {
                a.setLogo(!0);
                var b, c = "css/skins/default-ie8.css";
    ...
    build: function() {
        ...
        var g = $("<div />").addClass("color-gradient").append($("<input />").attr("id", "colorGradient").attr("checked", "checked").attr("type", "checkbox"), $("<label />").attr("for", "colorGradient").html("Gradient")),
    ...
    setPattern: function(a) {
        ...
        b && $("html").css("background-image", "url(img/patterns/" + a + ".png)"), $.cookie("pattern", a)
    },
    setLogo: function(a) {
        a || $.cookie("skin") == this.container.find("ul[data-type=colors] li:first a").attr("data-color-hex") && "dark" != $.cookie("backgroundcolor") ? $("h1.logo img").attr("src", "img/logo-default.png") : "dark" == $.cookie("backgroundcolor") ? $("h1.logo img").attr("src", "img/logo-dark.png") : $("h1.logo img").attr("src", "img/logo.png")
    },
    reset: function() {
        $.removeCookie("skin"), $.removeCookie("layout"), $.removeCookie("background"), $.removeCookie("pattern"), $.removeCookie("color"), $.cookie("showSwitcher", !0), window.location.reload()
    },
    getCss: function() {
        raw = "";
